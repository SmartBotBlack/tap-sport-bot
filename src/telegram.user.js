// ==UserScript==
// @name         Telegram path for TapSport Bot [SmartBot]
// @namespace    https://smartbot.black/
// @version      1.0.0
// @description  A script for telegram that helps you run tap-sport game directly in your browser.
...
(() => {
	const modifyIframeUrl = (iframe) => {
		...
		if (
			url.host.includes("app.tapsport.io") &&
